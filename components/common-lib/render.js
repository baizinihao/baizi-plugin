...
export default async function (path, params, cfg) {
  ...
  let data = {
    ...
    sys: {
      scale: 1,
      copyright: `<div style="text-align:center">白子API:&nbsp;<span style="color:Pink;">baizi</span><span style="color:White;"> & 白子API:<span style="color:Pink;">
白子API baizihaoxiao.xin<span style="color:White;"><br>Created By TRSS-Yunzai<span class="version">${Version.yunzai}</span> &nbsp baizi-plugin<span class="version">${Version.ver}</span>`
    },
	quality: 100
  }
